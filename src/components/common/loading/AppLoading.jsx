...
import appLogo from "@/assets/swapImg.png";
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-gradient-to-br from-blue-400 to-indigo-500 flex justify-center items-center z-50 overflow-hidden"
      >
